...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'Username', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'vorname', '' . "\0" . 'App\\Entity\\User' . "\0" . 'nachname'];
        }
     ...
     * {@inheritDoc}
     */
    public function setVorname(?string $vorname): \App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setNachname(?string $nachname): \App\Entity\User
    {
