 ...
 */
class getVerifyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VerifyRepository' shared autowired service.
     *
     * @return \App\Repository\VerifyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VerifyRepository.php';

        return $container->privates['App\\Repository\\VerifyRepository'] = new \App\Repository\VerifyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
