...
return [
    ...
    'app_user_post_get_user_api' => [['_format'], ['_format' => 'json', '_controller' => 'App\\Controller\\UserController::POST_GET_User_API'], ['_format' => 'json'], [['variable', '.', 'json', '_format', true], ['text', '/api/user']], [], []],
    'app_user_login_user_api' => [['_format'], ['_format' => 'html', '_controller' => 'App\\Controller\\UserController::Login_User_API'], ['_format' => 'html|json'], [['variable', '.', 'html|json', '_format', true], ['text', '/api/login']], [], []],
