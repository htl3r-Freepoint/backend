...
return [
    ...
    'app_design_checkmanually' => [[], ['_controller' => 'App\\Controller\\DesignController::checkManually'], [], [['text', '/requestchecker/checkmanually']], [], []],
    'app_design_checkautomagic' => [['_format'], ['_format' => 'html', '_controller' => 'App\\Controller\\DesignController::checkAutomagic'], ['_format' => 'html|json'], [['variable', '.', 'html|json', '_format', true], ['text', '/requestchecker/checkautomatic']], [], []],
    ...
    'add_qrcode_json' => [['string'], ['_format' => 'html', '_controller' => 'App\\Controller\\QrcodeController::Add_QrCode_API'], ['_format' => 'html|json|xml'], [['variable', '/', '[^/]++', 'string', true], ['text', '/api/AddQrCode']], [], []],
