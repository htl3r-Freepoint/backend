 ...
 */
class getKasseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\KasseRepository' shared autowired service.
     *
     * @return \App\Repository\KasseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'KasseRepository.php';

        return $container->privates['App\\Repository\\KasseRepository'] = new \App\Repository\KasseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
