 ...
 */
final class Version20210302091333 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE statistik (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fk_firma_id INTEGER NOT NULL, type VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE statistik');
