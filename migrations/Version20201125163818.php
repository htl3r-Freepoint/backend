 ...
 */
final class Version20201125163818 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE verify (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, register_date DATE NOT NULL, verfiy_date DATE NOT NULL, code VARCHAR(1048) NOT NULL)');
