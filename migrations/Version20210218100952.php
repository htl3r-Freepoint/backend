 ...
 */
final class Version20210218100952 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN locked BOOLEAN DEFAULT NULL');
        $this->addSql('CREATE TEMPORARY TABLE __temp__widerspruchsrecht AS SELECT id, data, email FROM widerspruchsrecht');
        ...
        $this->addSql('INSERT INTO widerspruchsrecht (id, data, email) SELECT id, data, email FROM __temp__widerspruchsrecht');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__rabatt');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, email, vorname, nachname, password, verified, login_type FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, vorname VARCHAR(255) DEFAULT NULL, nachname VARCHAR(255) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, verified BOOLEAN NOT NULL, login_type VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, email, vorname, nachname, password, verified, login_type) SELECT id, username, email, vorname, nachname, password, verified, login_type FROM __temp__user');
