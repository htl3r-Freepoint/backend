 ...
 */
final class Version20210129124752 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__rabatt AS SELECT id, fk_firma_id, x_punkte_fuer_1_rabatt FROM rabatt');
        $this->addSql('DROP TABLE rabatt');
        $this->addSql('CREATE TABLE rabatt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fk_firma_id INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL, title CLOB NOT NULL, text CLOB DEFAULT NULL, is_percent BOOLEAN NOT NULL, needed_points DOUBLE PRECISION NOT NULL, kategorie CLOB NOT NULL)');
        $this->addSql('INSERT INTO rabatt (id, fk_firma_id, price) SELECT id, fk_firma_id, x_punkte_fuer_1_rabatt FROM __temp__rabatt');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__qrcode');
        $this->addSql('CREATE TEMPORARY TABLE __temp__rabatt AS SELECT id, fk_firma_id FROM rabatt');
        $this->addSql('DROP TABLE rabatt');
        ...
        $this->addSql('INSERT INTO rabatt (id, fk_firma_id) SELECT id, fk_firma_id FROM __temp__rabatt');
        $this->addSql('DROP TABLE __temp__rabatt');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_rabatte AS SELECT rabatt_code, fk_user_id, fk_rabatt_id, used FROM user_rabatte');
        $this->addSql('DROP TABLE user_rabatte');
