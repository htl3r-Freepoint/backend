 ...
 */
final class Version20210218093226 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__widerspruchsrecht AS SELECT id, data FROM widerspruchsrecht');
        $this->addSql('DROP TABLE widerspruchsrecht');
        $this->addSql('CREATE TABLE widerspruchsrecht (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, data CLOB NOT NULL, email VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO widerspruchsrecht (id, data) SELECT id, data FROM __temp__widerspruchsrecht');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__widerspruchsrecht AS SELECT id, data FROM widerspruchsrecht');
        $this->addSql('DROP TABLE widerspruchsrecht');
        $this->addSql('CREATE TABLE widerspruchsrecht (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, data CLOB NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO widerspruchsrecht (id, data) SELECT id, data FROM __temp__widerspruchsrecht');
        $this->addSql('DROP TABLE __temp__widerspruchsrecht');
    }
}
