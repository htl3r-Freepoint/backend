 ...
 */
final class Version20201113102421 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE kasse (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fk_firma_id INTEGER NOT NULL, bezeichnung VARCHAR(1024) NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_rabatte AS SELECT rabatt_code, fk_user_id, fk_rabatt_id FROM user_rabatte');
        $this->addSql('DROP TABLE user_rabatte');
        $this->addSql('CREATE TABLE user_rabatte (fk_user_id INTEGER NOT NULL, fk_rabatt_id INTEGER NOT NULL, rabatt_code VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user_rabatte (rabatt_code, fk_user_id, fk_rabatt_id) SELECT rabatt_code, fk_user_id, fk_rabatt_id FROM __temp__user_rabatte');
        $this->addSql('DROP TABLE __temp__user_rabatte');
    }
}
