 ...
 */
final class Version20210318153832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rabatt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fk_firma_id INTEGER NOT NULL, is_percent BOOLEAN NOT NULL, needed_points DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION DEFAULT NULL, percentage DOUBLE PRECISION DEFAULT NULL, title CLOB NOT NULL, text CLOB DEFAULT NULL, kategorie CLOB DEFAULT NULL, pos CLOB DEFAULT NULL)');
