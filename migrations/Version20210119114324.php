 ...
 */
final class Version20210119114324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE login_authentification ADD COLUMN creation_date DATE NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__login_authentification AS SELECT id, fk_user_id, hash, valid FROM login_authentification');
        $this->addSql('DROP TABLE login_authentification');
        $this->addSql('CREATE TABLE login_authentification (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fk_user_id INTEGER NOT NULL, hash VARCHAR(1000) NOT NULL, valid BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO login_authentification (id, fk_user_id, hash, valid) SELECT id, fk_user_id, hash, valid FROM __temp__login_authentification');
        $this->addSql('DROP TABLE __temp__login_authentification');
