 ...
 */
final class Version20210129130445 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__rabatt AS SELECT id, fk_firma_id, price, title, text, is_percent, needed_points, kategorie FROM rabatt');
        $this->addSql('DROP TABLE rabatt');
        $this->addSql('CREATE TABLE rabatt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fk_firma_id INTEGER NOT NULL, is_percent BOOLEAN NOT NULL, needed_points DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION DEFAULT NULL, title CLOB NOT NULL, text CLOB DEFAULT NULL, kategorie CLOB DEFAULT NULL, percentage DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO rabatt (id, fk_firma_id, price, title, text, is_percent, needed_points, kategorie) SELECT id, fk_firma_id, price, title, text, is_percent, needed_points, kategorie FROM __temp__rabatt');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__rabatt AS SELECT id, fk_firma_id, price, title, text, is_percent, needed_points, kategorie FROM rabatt');
        $this->addSql('DROP TABLE rabatt');
        $this->addSql('CREATE TABLE rabatt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fk_firma_id INTEGER NOT NULL, is_percent BOOLEAN NOT NULL, needed_points DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, title CLOB NOT NULL COLLATE BINARY, text CLOB DEFAULT NULL COLLATE BINARY, kategorie CLOB NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO rabatt (id, fk_firma_id, price, title, text, is_percent, needed_points, kategorie) SELECT id, fk_firma_id, price, title, text, is_percent, needed_points, kategorie FROM __temp__rabatt');
        $this->addSql('DROP TABLE __temp__rabatt');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_rabatte AS SELECT rabatt_code, fk_user_id, fk_rabatt_id, used FROM user_rabatte');
        $this->addSql('DROP TABLE user_rabatte');
