 ...
 */
final class Version20210218091503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE widerspruchsrecht (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, data CLOB NOT NULL)');
