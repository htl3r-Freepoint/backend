 ...
 */
final class Version20201124095319 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN login_type VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, vorname VARCHAR(255) DEFAULT NULL, nachname VARCHAR(255) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, verified BOOLEAN NOT NULL)');
