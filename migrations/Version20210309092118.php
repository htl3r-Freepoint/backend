 ...
 */
final class Version20210309092118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__design AS SELECT id, name, datei, typ FROM design');
        $this->addSql('DROP TABLE design');
        $this->addSql('CREATE TABLE design (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, typ VARCHAR(255) DEFAULT NULL COLLATE BINARY, datei BLOB DEFAULT NULL, sting_datei VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO design (id, name, datei, typ) SELECT id, name, datei, typ FROM __temp__design');
        $this->addSql('DROP TABLE __temp__design');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__design AS SELECT id, name, datei, typ FROM design');
        $this->addSql('DROP TABLE design');
        $this->addSql('CREATE TABLE design (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, typ VARCHAR(255) DEFAULT NULL, datei BLOB NOT NULL)');
        $this->addSql('INSERT INTO design (id, name, datei, typ) SELECT id, name, datei, typ FROM __temp__design');
        $this->addSql('DROP TABLE __temp__design');
