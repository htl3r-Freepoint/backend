 ...
 */
final class Version20210113161633 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE design ADD COLUMN typ VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__design AS SELECT id, name, datei FROM design');
        ...
        $this->addSql('INSERT INTO design (id, name, datei) SELECT id, name, datei FROM __temp__design');
