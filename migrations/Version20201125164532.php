 ...
 */
final class Version20201125164532 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE verify ADD COLUMN fk_user_id INTEGER DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE verify (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, register_date DATE NOT NULL, verfiy_date DATE DEFAULT NULL, code VARCHAR(1048) NOT NULL)');
