 ...
 */
final class Version20201122105705 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_rabatte (rabatt_code VARCHAR(255) NOT NULL, fk_user_id INTEGER NOT NULL, fk_rabatt_id INTEGER NOT NULL, used BOOLEAN DEFAULT NULL)');
