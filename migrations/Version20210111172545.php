 ...
 */
final class Version20210111172545 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE betrieb ADD COLUMN laengengrad VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE betrieb ADD COLUMN breitengrad VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__betrieb AS SELECT id, fk_firma_id, addresse, plz, ort FROM betrieb');
        ...
        $this->addSql('INSERT INTO betrieb (id, fk_firma_id, addresse, plz, ort) SELECT id, fk_firma_id, addresse, plz, ort FROM __temp__betrieb');
        $this->addSql('DROP TABLE __temp__betrieb');
